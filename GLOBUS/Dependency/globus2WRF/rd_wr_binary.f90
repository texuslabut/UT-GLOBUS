...
!
   ...
   integer :: istatus
   character (len=256) :: name_ufrac,name_urb_par
...
! check and adapt if needed
   ...
   name_ufrac='urb_fra/ufrac'
   name_urb_par='morph/urb_param'
...
! Do not change anything here
   ...
   write (10,*)'latmin=',latmin
   write (10,*)'lonmin=',longmin
   write (10,*)'dx=',dx
   write (10,*)'dy=',dy
   close (10)
...
! change this
   ...
   open(unit=20,file='others/LambdaP_average_1kmx1km.txt',status='old')
   do i=1,nx
    do j=ny,1,-1
   ...
   close(20)
!
   open(unit=20,file='others/Lambdab_average_1kmx1km.txt',status='old')
   do i=1,nx
    do j=ny,1,-1
   ...
   close(20)
!
   open(unit=20,file='others/MeanBuildingHeight_average_1kmx1km.txt',status='old')
   do i=1,nx
    do j=ny,1,-1
    read(20,*)hmean_i(i,j)
    enddo
   ...
   close(20)
!
   open(unit=20,file='others/LambdaU_average_1kmx1km.txt',status='old')
   do i=1,nx
    do j=ny,1,-1
